...
import { fetchKBArticles, deleteKBArticle } from '../services/kbApi';
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-slate-200">
              {articles.map((article) => {
                ...
                return (
                  // Find the <tr> tag around line 120 and update it:

<tr 
  key={article.id} 
  onClick={() => navigate(`/kb/${article.id}`)} // ✅ ADD THIS
  className="hover:bg-slate-50 transition cursor-pointer" // ✅ ADD cursor-pointer
>
  ...
  <td className="px-4 py-3" onClick={(e) => e.stopPropagation()}> {/* ✅ ADD stopPropagation */}
